...
public class Spellbook
{
    ...
    public Spellbook(GameObject player){
        ...
        AllSpells.Add(new FireBallSpell("iceSpearSpell", "Ice Spear", Resources.Load("IceSpearPrefab") as GameObject));
        AllSpells.Add(new FireBallSpell("shieldSpell", "Arcane Shield", Resources.Load("ArcaneShieldPrefab") as GameObject));
